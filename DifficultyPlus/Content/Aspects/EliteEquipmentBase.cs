...
using System.Text;
using UnityEngine;
using static DifficultyPlus.CoreModules.EliteModule;
using static RoR2.CombatDirector;

namespace DifficultyPlus.Equipment
{
    ...
    public abstract class EliteEquipmentBase
    {
        ...
        protected void CreateEliteEquipment()
        {
            ...
            BED.eliteRamp = DifficultyPlusPlugin.assetBundle.LoadAsset<Texture>(DifficultyPlusPlugin.assetsPath + EliteRampTextureName + ".png");
